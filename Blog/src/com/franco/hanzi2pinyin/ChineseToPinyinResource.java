...
public class ChineseToPinyinResource {
    ...
    private void initializeResource() {
        try {
            ...
            getUnicodeToHanyuPinyinTable().load(
                    ResourceHelper.getResourceInputStream(resourceName));
    ...
    public static ChineseToPinyinResource getInstance() {
        ...
        return ChineseToPinyinResourceHolder.getInstance();
    }

    public static void recyleChineseToPinyin() {
        ChineseToPinyinResourceHolder.recyleChineseToPinyin();
    }
    ...
    private static class ChineseToPinyinResourceHolder {
        // static final ChineseToPinyinResource theInstance = new
        // ChineseToPinyinResource();
        static SoftReference<ChineseToPinyinResource> theInstance = new SoftReference<ChineseToPinyinResource>(
                new ChineseToPinyinResource());

        static ChineseToPinyinResource getInstance() {
            if (null == theInstance.get()) {
                theInstance = new SoftReference<ChineseToPinyinResource>(
                        new ChineseToPinyinResource());
            }
            return theInstance.get();
        }

        static void recyleChineseToPinyin() {
            if (theInstance != null) {
                theInstance = null;
            }
        }
